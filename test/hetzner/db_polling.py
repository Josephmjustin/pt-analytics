...
DB_CONFIG = {
    "host": os.getenv("HETZNER_DB_HOST"),
    "database": os.getenv("HETZNER_DB_NAME"),
    "user": os.getenv("HETZNER_DB_USER"),
    "password": os.getenv("HETZNER_DB_PASSWORD"),
    "port": os.getenv("HETZNER_DB_PORT", 5432)
}
