...
--
-- Name: bunching_by_day; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_hour; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_hour_day; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_month; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_stop; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: bunching_scores; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: bunching_scores_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: bunching_scores_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: osm_stops; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: route_headway_baselines; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.route_headway_baselines (
    route_id text NOT NULL,
    stop_id text NOT NULL,
    stop_name text,
...
--
-- Name: bunching_scores id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_day bunching_by_day_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_hour_day bunching_by_hour_day_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_hour bunching_by_hour_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_month bunching_by_month_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bunching_by_stop bunching_by_stop_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bunching_scores bunching_scores_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: osm_stops osm_stops_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: route_headway_baselines route_headway_baselines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.route_headway_baselines
    ADD CONSTRAINT route_headway_baselines_pkey PRIMARY KEY (route_id, stop_id);


--
-- Name: bunching_scores unique_stop_analysis; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vehicle_positions unique_vehicle_timestamp; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_bunching_scores_stop; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bunching_scores_timestamp; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_day; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gtfs_stops_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gtfs_trips_route_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_hour_day; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_month; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_osm_stops_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_route_headway_route; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_route_headway_route ON public.route_headway_baselines USING btree (route_id);


--
-- Name: idx_route_headway_stop; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_route_headway_stop ON public.route_headway_baselines USING btree (stop_id);


--
-- Name: idx_route_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_vehicle_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_vehicle_positions_geom; Type: INDEX; Schema: public; Owner: -
--
